# As originally written, the PostalService object didn't have access to any custom #send method, so calling #send on that object was actually a call to Object#send, which was not what we wanted. To fix this, I included the Mailing module in the PostalService class, giving PostalService objects access to the custom #send method in the Mailing module.

# We've also renamed Mailing#send Mailing#send_mail, so that we're not overriding Object#send, in case an instance needs to call Object#send.
